        ...
        <nav className="max-w-[103rem] mx-auto relative z-[999] flex items-center justify-between py-3 px-5 ">
          ...
          <div className="flex items-center gap-4 lg:gap-10">
            <button
              ...
              className="capitalize text-[.8rem] font-poppins-medium cursor-pointer hover:text-orange transition-colors"
            >
              Login
            </button>
            <button className="bg-orange px-3 py-1 lg:px-3 lg:py-2 xl:px-5 xl:py-2 rounded-[8px] text-white capitalize text-[.7rem] xl:text-[.8rem] font-poppins-medium cursor-pointer text-nowrap hover:shadow-lg hover:scale-105 transition-all ">
              My Cart
            </button>
          </div>
        </nav>
