...
const Footer = () => {
  return (
    <footer className="w-full h-[192vh] lg:h-[55vh] relative bg-black px-[5vw] ">
      <div className="max-w-screen-2xl h-full mx-auto relative pt-[4vw] ">
        {/* -- */}
        <div className="w-full lg:h-[35vh] flex flex-col lg:flex-row lg:items-center lg:justify-between ">
          {/* left */}
          <div className="w-full h-1/2 lg:w-1/3 lg:h-full ">
            <img
              src="/HomePage/header/logo-dark.png"
              alt=""
              className="w-[12rem] object-cover object-center "
            />
            <p className="text-white/70 font-poppins-light text-[.9rem] mt-5 lg:mt-10 ">
          ...
          {/* right */}
          <div className="w-full lg:w-2/3 h-full flex flex-col lg:flex-row justify-between gap-7 lg:gap-0 mt-5 lg:mt-0 ">
            {/* -- */}
            <div className="w-[6vw] h-full shrink-0 text-nowrap ">
              <div>
        ...
        {/* -- */}
        <div className="w-full py-5 text-white/70 font-poppins-light text-[.9rem] flex flex-col lg:flex-row lg:items-center lg:justify-between text-nowrap gap-5 lg:gap-0 ">
